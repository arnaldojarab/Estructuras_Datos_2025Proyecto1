...
La lógica de los pedidos se divide en 3 clases:
...
- **_base_ids_sorted**: **Copia (lista)** de todos los ids de los jobs; es útil para realizar varias acciones, pero principalmente para poder rellenar la cola `release_queue` cuando esta se queda sin pedidos.  
